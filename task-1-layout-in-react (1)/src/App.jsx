...
const firstParagraph = "Lorem ipsum odor amet, consectetuer adipiscing elit. Mi eu scelerisque turpis posuere tempor? Leo condimentum himenaeos molestie elit; maximus iaculis proin nulla. Ullamcorper nibh cras conubia suscipit dapibus sagittis, facilisi habitant vivamus. Etiam fusce posuere himenaeos ipsum commodo sollicitudin himenaeos nec."
...
function SocialIcons() {
  return (
    <div className="social-icons">
      ...
      <img className="x-icon" src="/assets/twitter-icon.svg" alt="X (Twitter)" />
    </div>
  )
}
...
function App() {
  return (
    <>
      <header>
        <img className="logo" src="/assets/logo.svg" alt="Erased Tapes logo" />
        <Navigation />
      </header>
      ...
      <main id="blog">
        ...
        <section id="artists" className="album-grid">
          <img className="featured-album" src="/assets/all-encores.jpg" alt="All Encores album cover" />
          <img src="/assets/eulogy-for-evolution.jpg" alt="Eulogy for Evolution album cover" />
          <img src="/assets/the-cell.jpg" alt="The Cell album cover" />
          <img src="/assets/articulation.jpg" alt="Articulation album cover" />
          <img src="/assets/encores-2.jpg" alt="Encores 2 album cover" />
        </section>

        <section id="story" className="author">
          <div>
            <h2>The Author</h2>
          ...
          <img className="author-photo" src="/assets/profile_picture.jpg" alt="The author" />
          <SocialIcons />
        </section>
